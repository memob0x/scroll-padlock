...
describe('html-scroll-standard', () => {
  ...
  it('should be able to ensure scroll position standard approach', async () => {
    const page = await browseHtmlPlaygroundFile(browser, resolve('./test/e2e/html-scroll-standard.html'));
    ...
    const firstImage = await takeBrowserScreenshot(page, 'html-scroll-standard-0');

    await page.evaluate(() => window.lock());

    const secondImage = await takeBrowserScreenshot(page, 'html-scroll-standard-1');
    ...
    const thirdImage = await takeBrowserScreenshot(page, 'html-scroll-standard-2');
    ...
    const fourthImage = await takeBrowserScreenshot(page, 'html-scroll-standard-3');
