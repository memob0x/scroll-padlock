...
describe('html-scroll-position-fixed', () => {
  ...
  it('should be able to ensure scroll position fixed approach', async () => {
    const page = await browseHtmlPlaygroundFile(browser, resolve('./test/e2e/html-scroll-position-fixed.html'));
    ...
    const firstImage = await takeBrowserScreenshot(page, 'html-scroll-position-fixed-0');
    ...
    const secondImage = await takeBrowserScreenshot(page, 'html-scroll-position-fixed-1');
    ...
    const thirdImage = await takeBrowserScreenshot(page, 'html-scroll-position-fixed-2');
    ...
    const fourthImage = await takeBrowserScreenshot(page, 'html-scroll-position-fixed-3');
