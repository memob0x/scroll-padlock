 ...
 * @property {number} scrollTop The number of pixels the element's content is scrolled vertically.
 * @property {number} scrollLeft The number of pixels the element's content is scrolled horizontally.
 * @property {number} scrollWidth The total width of the element's scrollable content, including the non-visible part.
 * @property {number} scrollHeight The total height of the element's scrollable content, including the non-visible part.
