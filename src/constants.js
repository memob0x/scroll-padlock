...
// CSS variables names
export const CSS_VAR_NAME_POSITION_TOP = CSS_VAR_PREFIX
 + DOM_BASE_NAME
 + HYPHEN
 + SCROLL
 + HYPHEN
 + TOP;
export const CSS_VAR_NAME_POSITION_LEFT = CSS_VAR_PREFIX
 + DOM_BASE_NAME
 + HYPHEN
 + SCROLL
 + HYPHEN
 + LEFT;
export const CSS_VAR_NAME_SCROLLBAR_WIDTH = CSS_VAR_PREFIX
 + DOM_BASE_NAME
 + HYPHEN
 + SCROLLBAR
 + HYPHEN
 + WIDTH;
export const CSS_VAR_NAME_SCROLLBAR_HEIGHT = CSS_VAR_PREFIX
 + DOM_BASE_NAME
 + HYPHEN
 + SCROLLBAR
 + HYPHEN
 + HEIGHT;
export const CSS_VAR_NAME_OUTER_WIDTH = CSS_VAR_PREFIX
 + DOM_BASE_NAME
 + HYPHEN
 + OUTER
 + HYPHEN
 + WIDTH;
export const CSS_VAR_NAME_OUTER_HEIGHT = CSS_VAR_PREFIX
 + DOM_BASE_NAME
 + HYPHEN
 + OUTER
 + HYPHEN
 + HEIGHT;
export const CSS_VAR_NAME_INNER_WIDTH = CSS_VAR_PREFIX
 + DOM_BASE_NAME
 + HYPHEN
 + INNER
 + HYPHEN
 + WIDTH;
export const CSS_VAR_NAME_INNER_HEIGHT = CSS_VAR_PREFIX
 + DOM_BASE_NAME
 + HYPHEN
 + INNER
 + HYPHEN
 + HEIGHT;
export const CSS_VAR_NAME_SCROLL_WIDTH = CSS_VAR_PREFIX
 + DOM_BASE_NAME
 + HYPHEN
 + SCROLL
 + HYPHEN
 + WIDTH;
export const CSS_VAR_NAME_SCROLL_HEIGHT = CSS_VAR_PREFIX
 + DOM_BASE_NAME
 + HYPHEN
 + SCROLL
 + HYPHEN
